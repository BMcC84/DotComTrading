        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BacklinkCount = table.Column<long>(type: "bigint", nullable: false),
                    FriendlyBacklinkCount = table.Column<int>(type: "int", nullable: false),
                    DomainAge = table.Column<int>(type: "int", nullable: false),
                    LifetimeVisits = table.Column<long>(type: "bigint", nullable: false),
                    DailyVisits = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Holdings_Websites_WebsiteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Holdings_PortfolioId_WebsiteId",
                table: "Holdings",
                columns: new[] { "PortfolioId", "WebsiteId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Holdings_WebsiteId",
                table: "Holdings",
                column: "WebsiteId");
